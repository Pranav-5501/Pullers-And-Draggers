...
HUL_weightage = 1.52
stock_symbol = "HU"
stock_url = 'https://www.moneycontrol.com/india/stockpricequote/personal-care/hindustanunilever/HU'
headers = {'user-agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.117 Safari/537.36'}
...
HUL_price = float(data_array[0].replace(',',''))
y = data_chg[0].split('(')
z = (y[1].split('%'))
HUL_change = float(z[0])


#calculation
w_move = (HUL_change * HUL_weightage) / 10000
index = Nifty * w_move;
