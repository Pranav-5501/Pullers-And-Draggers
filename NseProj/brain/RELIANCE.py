...
def price(Nifty):
    ...
    w_move = (RELIANCE_change * Weightage) / 10000
    index = Nifty * w_move;
    RELIANCE_points = ("%.2f" % index)
    return(RELIANCE_val,RELIANCE_change,RELIANCE_points)


NIFTY = niftyprice.Nifty
RELIANCE_val,RELIANCE_change,RELIANCE_points = price(NIFTY)