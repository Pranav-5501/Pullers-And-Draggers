...
def HDFCBANK_price(Nifty):
    ...
    w_move = (HDFCBANK_change * Weightage) / 10000
    index = Nifty * w_move;
    HDFCBANK_points = ("%.2f" % index)
    return(HDFCBANK_val,HDFCBANK_change,HDFCBANK_points)


NIFTY = niftyprice.Nifty
HDFCBANK_val,HDFCBANK_change,HDFCBANK_points = HDFCBANK_price(NIFTY)
