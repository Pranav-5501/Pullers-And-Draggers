...
def price(Nifty):
    ...
    sp1 = sp[0]
    KOTAKBANK_change = float(sp1[1:-1])
    ...
    w_move = (KOTAKBANK_change * Weightage) / 10000
    index = Nifty * w_move;
    KOTAKBANK_points = ("%.2f" % index)
    return(KOTAKBANK_val,KOTAKBANK_change,KOTAKBANK_points)


NIFTY = niftyprice.Nifty
KOTAKBANK_val,KOTAKBANK_change,KOTAKBANK_points = price(NIFTY)