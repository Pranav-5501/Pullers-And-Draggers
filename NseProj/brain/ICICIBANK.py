...
def price(Nifty):
    ...
    sp1 = sp[0]
    ICICIBANK_change = float(sp1[1:-1])
    ...
    w_move = (ICICIBANK_change * Weightage) / 10000
    index = Nifty * w_move;
    ICICIBANK_points = ("%.2f" % index)
    return(ICICIBANK_val,ICICIBANK_change,ICICIBANK_points)


NIFTY = niftyprice.Nifty
ICICIBANK_val,ICICIBANK_change,ICICIBANK_points = price(NIFTY)